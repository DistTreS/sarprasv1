...
<div class="container">
    ...
    <form action="<?= site_url('inventaris/submit_request') ?>" method="post">
        ...
        <div class="requester-info">
            <select name="nama_peminta" required>
                <option value="">Pilih Nama Peminta</option>
                <?php if (isset($userId) && is_array($userId)): ?>
...
//     <?php
    echo '<pre>';
    print_r($userId); // Cek isi variabel $userId di view
    print_r($items);  // Cek isi variabel $items di view
    echo '</pre>';
?>
