    ...
    <table>
        ...
        <?php foreach ($peminjaman as $item) : ?>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('peminjaman/detail/' . $item['id_pengajuan']); ?>" class="btn btn-detail">Lihat Detail</a>

                    <?php if ($item['status_layanan'] == 'Proses' || $item['status_layanan'] == 'Selesai') : ?>
                        <a href="<?= base_url('peminjaman/pengembalian/' . $item['id_pengajuan']); ?>" class="btn btn-kembali">Pengembalian</a>
                    <?php endif; ?>
                </td>
            </tr>
        <?php endforeach; ?>
