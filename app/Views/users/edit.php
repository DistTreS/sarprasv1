            ...
            <form action="<?= base_url('users/update/' . $user['id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="role" class="form-control">
                        ...
                        <option value="Admin Utama" <?= ($user['role'] == 'Admin Utama') ? 'selected' : '' ?>>Admin Utama</option>
                        <option value="Admin Peminjaman" <?= ($user['role'] == 'Admin Peminjaman') ? 'selected' : '' ?>>Admin Peminjaman</option>
                        <option value="Admin Barang" <?= ($user['role'] == 'Admin Barang') ? 'selected' : '' ?>>Admin Barang</option>
                        <option value="Admin Diklat" <?= ($user['role'] == 'Admin Diklat') ? 'selected' : '' ?>>Admin Diklat</option>
                        <option value="Admin Peminjaman dan Barang" <?= ($user['role'] == 'Admin Peminjaman dan Barang') ? 'selected' : '' ?>>Admin Peminjaman dan Barang</option>
                        <option value="Admin Peminjaman dan Diklat" <?= ($user['role'] == 'Admin Peminjaman dan Diklat') ? 'selected' : '' ?>>Admin Peminjaman dan Diklat</option>
                        <option value="Admin Barang dan Diklat" <?= ($user['role'] == 'Admin Barang dan Diklat') ? 'selected' : '' ?>>Admin Barang dan Diklat</option>
                    </select>
                </div>
